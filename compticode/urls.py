...
urlpatterns=[
    ...
    path('<int:contest_id>',views.compticode_contest,name='contest'),
    ...
    path('<int:contest_id>/edit_question/<int:question_id>',views.add_or_edit_question,name='edit_question'),
